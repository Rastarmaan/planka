...
export default {
  ...
  translation: {
    common: {
      ...
      projectAnalysisDashboard: 'Project Analysis Dashboard',
      ...
      addReport_title: 'Add Report',
      editReport_title: 'Edit Report',
      deleteReport_title: 'Delete Report',
      reportName: 'Report Name',
      noReportsYet: 'No reports yet',
      searchReports: 'Search reports...',
      searchPhases: 'Search phases...',
      noMatchingPhases: 'No matching phases found',
      areYouSureYouWantToDeleteThisReport: 'Are you sure you want to delete this report?',
      phase: 'Phase',
      phases: 'Phases',
      addPhase: 'Add Phase',
      addPhase_title: 'Add Phase',
      addPhases_title: 'Add Phases',
      editPhase_title: 'Edit Phase',
      deletePhase_title: 'Delete Phase',
      phaseName: 'Phase Name',
      phaseDescription: 'Phase Description',
      phaseStatus: 'Status',
      noPhasesYet: 'No phases yet',
      areYouSureYouWantToDeleteThisPhase: 'Are you sure you want to delete this phase?',
      statusTodo: 'To Do',
      ...
      projectProfiles_title: 'Project Profiles',
      projectProfiles_description: 'Manage project profiles for your organization',
      projectProfiles_project_title: 'Project',
      addProjectProfile_title: 'Add Project Profile',
      editProjectProfile_title: 'Edit Project Profile',
      deleteProjectProfile_title: 'Delete Project Profile',
      projectProfileName: 'Profile Name',
      enterProjectProfileName: 'Enter profile name',
      enterProjectProfileDescription: 'Enter profile description',
      isTemplate: 'Is Template',
      noProjectProfilesYet: 'No project profiles yet',
      noProfileTemplatesAvailable:
        'No profile templates available. Please create a template in the Administration panel first.',
      selectProfileTemplate: 'Select Profile Template',
      searchProfiles: 'Search profiles...',
      noResultsFound: 'No results found',
      viewAssignedProfiles: 'View Assigned Profiles',
      noAssignedProfiles: 'No profiles assigned to projects yet',
      profileName: 'Profile Name',
      createdAt: 'Created At',
      areYouSureYouWantToDeleteThisProfile: 'Are you sure you want to delete this profile?',
      areYouSureYouWantToDeleteThisProjectProfile:
        'Are you sure you want to delete this project profile?',

      section: 'Section',
      sections: 'Sections',
      addSection: 'Add Section',
      addSection_title: 'Add Section',
      editSection_title: 'Edit Section',
      deleteSection_title: 'Delete Section',
      ...
      manageSectionsAndFields: 'Manage Sections & Fields',
      ...
      fields: 'Fields',
      addField: 'Add Field',
      addField_title: 'Add Field',
      editField_title: 'Edit Field',
      deleteField_title: 'Delete Field',
      ...
      enterFieldOptions: 'Enter options (comma-separated)',
      fieldOptionsHelp: 'Enter options separated by commas, e.g., "Option 1, Option 2, Option 3"',
      ...
      sectionTypeTeam: 'Team',
      sectionTypeSocialMedia: 'Social Media',
      sectionTypeBrief: 'Brief',
      sectionTypeLogo: 'Logo',
      sectionTypeCustom: 'Custom',

      // Section types (snake_case)
      sectionType_team: 'Team',
      sectionType_social_media: 'Social Media',
      sectionType_socialMedia: 'Social Media',
      sectionType_brief: 'Brief',
      sectionType_logo: 'Logo',
      sectionType_custom: 'Custom',
      ...
      syncActive: 'Active',
      syncPaused: 'Paused',
      syncToNewBoard: 'Sync to another board',
      ...
      userCardStats: 'My card stats',
      userCardStatsTitle: 'Assigned cards statistics',
      assignedTasks: 'Assigned tasks',
      doneTasks: 'Done tasks',
      delayedTasks: 'Delayed tasks',
      noCardsForSelection: 'No cards found for this selection.',
    ...
    action: {
      ...
      editType_title: 'Edit Type',
      sync: 'Sync',
      syncCard_title: 'Sync Card',
      syncToBoard: 'Sync to another board',
      editUsername_title: 'Edit Username',
      emptyTrash: 'Empty trash',
      emptyTrash_title: 'Empty Trash',
      goToToday: 'Go to Today',
      ...
      selectColor_title: 'Select Color',
