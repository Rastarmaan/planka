...
const ReleaseItem = React.memo(({ release, onUpdate, onUpdateStatus, onDelete, onClick }) => {
    ...
    <>
      <div className={styles.releaseRow}>
        ...
        <div className={styles.actionsColumn}>
          <Button size="mini" icon basic onClick={handleEdit}>
            <Icon name="edit" />
          </Button>
          <Button size="mini" icon basic onClick={handleDelete}>
            <Icon name="trash" />
          </Button>
        </div>
      </div>
