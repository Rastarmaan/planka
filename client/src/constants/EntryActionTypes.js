...
export default {
  ...
  REPORT_CREATE: `${PREFIX}/REPORT_CREATE`,
  REPORT_CREATE_HANDLE: `${PREFIX}/REPORT_CREATE_HANDLE`,
  REPORT_UPDATE: `${PREFIX}/REPORT_UPDATE`,
  REPORT_UPDATE_HANDLE: `${PREFIX}/REPORT_UPDATE_HANDLE`,
  REPORT_DELETE: `${PREFIX}/REPORT_DELETE`,
  REPORT_DELETE_HANDLE: `${PREFIX}/REPORT_DELETE_HANDLE`,

  /* Report Phases */

  REPORT_PHASE_CREATE: `${PREFIX}/REPORT_PHASE_CREATE`,
  REPORT_PHASE_CREATE_HANDLE: `${PREFIX}/REPORT_PHASE_CREATE_HANDLE`,
  REPORT_PHASE_UPDATE: `${PREFIX}/REPORT_PHASE_UPDATE`,
  REPORT_PHASE_UPDATE_HANDLE: `${PREFIX}/REPORT_PHASE_UPDATE_HANDLE`,
  REPORT_PHASE_DELETE: `${PREFIX}/REPORT_PHASE_DELETE`,
  REPORT_PHASE_DELETE_HANDLE: `${PREFIX}/REPORT_PHASE_DELETE_HANDLE`,

  /* Project Profiles */

  PROJECT_PROFILE_CREATE: `${PREFIX}/PROJECT_PROFILE_CREATE`,
  PROJECT_PROFILE_CREATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_CREATE_HANDLE`,
  PROJECT_PROFILE_UPDATE: `${PREFIX}/PROJECT_PROFILE_UPDATE`,
  PROJECT_PROFILE_UPDATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_UPDATE_HANDLE`,
  PROJECT_PROFILE_DELETE: `${PREFIX}/PROJECT_PROFILE_DELETE`,
  PROJECT_PROFILE_DELETE_HANDLE: `${PREFIX}/PROJECT_PROFILE_DELETE_HANDLE`,

  /* Project Profile Sections */

  PROJECT_PROFILE_SECTION_CREATE: `${PREFIX}/PROJECT_PROFILE_SECTION_CREATE`,
  PROJECT_PROFILE_SECTION_CREATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_SECTION_CREATE_HANDLE`,
  PROJECT_PROFILE_SECTION_UPDATE: `${PREFIX}/PROJECT_PROFILE_SECTION_UPDATE`,
  PROJECT_PROFILE_SECTION_UPDATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_SECTION_UPDATE_HANDLE`,
  PROJECT_PROFILE_SECTION_DELETE: `${PREFIX}/PROJECT_PROFILE_SECTION_DELETE`,
  PROJECT_PROFILE_SECTION_DELETE_HANDLE: `${PREFIX}/PROJECT_PROFILE_SECTION_DELETE_HANDLE`,

  /* Project Histories */

  PROJECT_HISTORIES_FETCH: `${PREFIX}/PROJECT_HISTORIES_FETCH`,
  PROJECT_HISTORY_CREATE: `${PREFIX}/PROJECT_HISTORY_CREATE`,
  PROJECT_HISTORY_CREATE_HANDLE: `${PREFIX}/PROJECT_HISTORY_CREATE_HANDLE`,
  PROJECT_HISTORY_UPDATE: `${PREFIX}/PROJECT_HISTORY_UPDATE`,
  PROJECT_HISTORY_UPDATE_HANDLE: `${PREFIX}/PROJECT_HISTORY_UPDATE_HANDLE`,
  PROJECT_HISTORY_DELETE: `${PREFIX}/PROJECT_HISTORY_DELETE`,
  PROJECT_HISTORY_DELETE_HANDLE: `${PREFIX}/PROJECT_HISTORY_DELETE_HANDLE`,

  /* Project Stats */

  PROJECT_STATS_FETCH: `${PREFIX}/PROJECT_STATS_FETCH`,

  /* Project Profile Fields */

  PROJECT_PROFILE_FIELD_CREATE: `${PREFIX}/PROJECT_PROFILE_FIELD_CREATE`,
  PROJECT_PROFILE_FIELD_CREATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_FIELD_CREATE_HANDLE`,
  PROJECT_PROFILE_FIELD_UPDATE: `${PREFIX}/PROJECT_PROFILE_FIELD_UPDATE`,
  PROJECT_PROFILE_FIELD_UPDATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_FIELD_UPDATE_HANDLE`,
  PROJECT_PROFILE_FIELD_DELETE: `${PREFIX}/PROJECT_PROFILE_FIELD_DELETE`,
  PROJECT_PROFILE_FIELD_DELETE_HANDLE: `${PREFIX}/PROJECT_PROFILE_FIELD_DELETE_HANDLE`,

  /* Project Profile Data */

  PROJECT_PROFILE_DATA_LOAD: `${PREFIX}/PROJECT_PROFILE_DATA_LOAD`,
  PROJECT_PROFILE_DATA_LOAD_HANDLE: `${PREFIX}/PROJECT_PROFILE_DATA_LOAD_HANDLE`,
  PROJECT_PROFILE_DATA_SAVE: `${PREFIX}/PROJECT_PROFILE_DATA_SAVE`,
  PROJECT_PROFILE_DATA_SAVE_HANDLE: `${PREFIX}/PROJECT_PROFILE_DATA_SAVE_HANDLE`,

  /* Project Profile People (for people field type) */

  PROJECT_PROFILE_PEOPLE_LOAD: `${PREFIX}/PROJECT_PROFILE_PEOPLE_LOAD`,
  PROJECT_PROFILE_PEOPLE_LOAD_HANDLE: `${PREFIX}/PROJECT_PROFILE_PEOPLE_LOAD_HANDLE`,
  PROJECT_PROFILE_PERSON_CREATE: `${PREFIX}/PROJECT_PROFILE_PERSON_CREATE`,
  PROJECT_PROFILE_PERSON_CREATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_PERSON_CREATE_HANDLE`,
  PROJECT_PROFILE_PERSON_UPDATE: `${PREFIX}/PROJECT_PROFILE_PERSON_UPDATE`,
  PROJECT_PROFILE_PERSON_UPDATE_HANDLE: `${PREFIX}/PROJECT_PROFILE_PERSON_UPDATE_HANDLE`,
  PROJECT_PROFILE_PERSON_DELETE: `${PREFIX}/PROJECT_PROFILE_PERSON_DELETE`,
  PROJECT_PROFILE_PERSON_DELETE_HANDLE: `${PREFIX}/PROJECT_PROFILE_PERSON_DELETE_HANDLE`,
  ...
  IMPORT_PROGRESS_HANDLE: `${PREFIX}/IMPORT_PROGRESS_HANDLE`,
