...
module.exports.policies = {
  ...
  'project-stats/show': ['is-authenticated', 'is-external', 'is-admin-or-manager'],
  ...
  'user-card-stats/show': 'is-authenticated',
  ...
  'folders/create': ['is-authenticated', 'is-external'],
  'folders/show': ['is-authenticated', 'is-external'],
  'folders/download': ['is-authenticated', 'is-external'],
  'folders/update': ['is-authenticated', 'is-external', 'can-edit-folder'],
  'folders/delete': ['is-authenticated', 'is-external', 'can-edit-folder'],

  'document-files/upload': ['is-authenticated', 'is-external'],
  'document-files/show': ['is-authenticated', 'is-external'],
  'document-files/download': ['is-authenticated', 'is-external'],
  'document-files/update': ['is-authenticated', 'is-external', 'can-edit-file'],
  'document-files/delete': ['is-authenticated', 'is-external', 'can-edit-file'],

  'share-links/create': ['is-authenticated', 'is-external', 'is-admin'],
  'share-links/index': ['is-authenticated', 'is-external', 'is-admin'],
  'share-links/update': ['is-authenticated', 'is-external', 'is-admin'],
  'share-links/delete': ['is-authenticated', 'is-external', 'is-admin'],
  'share-links/access': true,
  'share-links/download': true,
  'share-links/download-folder': true,
  'share-links/download-folder-file': true,
  'share-links/preview': true,
  'share-links/preview-folder-file': true,
  ...
  'board-templates/show-all': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/create': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/show': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/update': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/delete': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/create-list': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/update-list': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/delete-list': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/create-card-type': ['is-authenticated', 'is-external', 'is-admin'],
  'board-templates/delete-card-type': ['is-authenticated', 'is-external', 'is-admin'],
